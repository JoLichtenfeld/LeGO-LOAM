...
// extern const string fileDirectory = "/home/share/pcd/";
...
extern const int groundScanInd = 60;  // "a rough number of scan lines that will cover the ground"

extern const bool loopClosureEnableFlag = true;  // false;
...
extern const float segmentTheta = 60.0 / 180.0 * M_PI;  // decrease this value may improve accuracy
...
extern const float surroundingKeyframeSearchRadius =
    100.0;  // key frame that is within n meters from current pose will be considerd for scan-to-map optimization (when
...
extern const int historyKeyframeSearchNum =
    25;  // 2n+1 number of hostory key frames will be fused into a submap for loop closure
